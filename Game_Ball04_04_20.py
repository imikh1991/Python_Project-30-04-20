...
# создаём новый объект — окно с игровым полем. В нашем случае переменная окна называется tk, и мы его сделали из
...
class Ball:
    ...
    def __init__(self, canvas, paddle, score, color):
        ...
        self.id = canvas.create_oval(15, 15, 30, 30, fill=color)
        # помещаем шарик в точку с координатами random по двум осям
        x = random.randrange(22, 250, 10)
        y = random.randrange(22, 250, 10)
